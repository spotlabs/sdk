 ...
 *  	<li>accessing NV platform services</li>
 *  </ul>
 *  
 *  
...
public class NVApplication extends Application {
    ...
    private static NVApplication sInstance;
    ...
    /**
     * Get a {@link com.spotlabs.app.NVServiceManager} instance to access NV services.
     *
     ...
     * @return <b>true</b> if the device is idle.
     */
    ...
    /**
     * Get the current running instance of NVApplication
     *
     * @return The current running instance of NVApplication
     */
